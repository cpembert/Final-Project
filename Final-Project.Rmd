...
In conclusion, Queens is a relatively good neighborhood, with low emergencies in the average New Yorker's areas of concern (Law Enforcement, Structual, Fire). In addition, in areas that had higher incidents, futher investigation by sub-catergory revealed positive insights. For example, though Ultility Incidents showcased the highest record of incidents in Queens; by sub-catergory I saw that Queens had the lowest record of Gas related incidents. Over all, through investigations, Queens is an average borough, with medium safety risk factors. 
